...
//provide brief description of the account Apis
@Tag(
        name = "Account APIs",
        description = "This APIs is used to create, fetch, update and delete account details"
)
@RestController
...
public class AccountController {
    ...
    //Provide detailed API response of the API
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
